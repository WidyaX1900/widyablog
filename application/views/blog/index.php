        ...
        <div class="col-lg-9">
            <div class="blog-post row mb-5">
                <div class="col-lg-6 thumbnail">
                    <img src="<?= base_url('assets/'); ?>img/samurai.jpg" alt="thumbnail" class="rounded">
                </div>
                <div class="col-lg-6 blog-desc">
                    <a href="">
                        <h3>Bushido - Principles of Samurai</h3>
                    </a>
                    <small>Published Date: August 20th, 2023</small>
                    <p class="mt-3">
            ...
            <div class="blog-post row">
                <div class="col-lg-6 thumbnail mb-5">
                    <img src="<?= base_url('assets/'); ?>img/mount.jpg" alt="thumbnail" class="rounded">
                </div>
                <div class="col-lg-6 blog-desc">
                    <a href="">
            ...
            <div class="blog-post row">
                <div class="col-lg-6 thumbnail">
                    <img src="<?= base_url('assets/'); ?>img/prambanan.jpg" alt="thumbnail" class="rounded">
                </div>
                <div class="col-lg-6 blog-desc">
                    <a href="">
